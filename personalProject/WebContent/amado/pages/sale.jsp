...
<div>
	<div style="position: absolute; z-index: 20; width: 50%; right: 0; text-align: center; top: auto; 
				margin-top: 7%; margin-right: 3%;">
		<h2 style="font-size: 2vw; font-weight: 700; margin-bottom: 27px;">
			최대 
			<span style="font-size: 5vw; padding-left: 5px; padding-right: 5px; line-height: 46px; 
	...
	<video src="../video/video-ld.mp4" width="100%" muted height="initial" autoplay loop style="position: relative;"></video>
</div>
