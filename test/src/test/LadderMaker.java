...
public class LadderMaker {
	...
	public static void main(String[] args) {
		...
		LadderOutput(LadderRandomNum());
			
	}
	
	//5부터 12까지 숫자 랜덤부분
	public static int LadderRandomNum() {
	...
	public static void LadderOutput(int num) {
		...
		String[][] ladderArr = new String[7][num]; // 행이 6개인 2중 배열 출력
		...
		for (int j = 0; j < num; j++) { //사다리 순서대로 결과 출력
