...
<header class="header-area clearfix">
	...
	<nav class="amado-nav">
		<ul>
			<li><a name="a" href="index.jsp">쇼핑</a></li>
			<li><a name="a" href="shop.jsp">디자이너</a></li>
			<li><a name="a" href="product-details.jsp">코디 북</a></li>
			<li><a name="a" href="cart.jsp">장바구니</a></li>
			<li><a name="a" href="checkout.jsp">바로 결제</a></li>
			...
			%>
				<li><a name="a" href="memberList.jsp">회원정보 조회</a></li>
			<%
				}
			%>
		</ul>
	...
	<div class="cart-fav-search mb-100">
		...
		<%
			if (admin != null) {
		%>
			<a href="loginForm2.jsp" class="search-nav">
			<img src="../img/core-img/login1.png" width="21px" height="21px" alt=""> 
			내 정보</a>
		<%
			} else {
		%>
			...
			<img src="../img/core-img/login1.png" width="21px" height="21px" alt=""> 
			로그인</a>
			<a href="inputForm.jsp" class="search-nav">
			<img src="../img/core-img/join.png" width="21px" height="21px" alt=""> 
			회원가입</a>
		<%
			}
		%>
			<a href="b_list.jsp?boardid=1" class="search-nav">
			<img src="../img/core-img/gongji.png" width="21px" height="21px" alt=""> 
			공지사항</a>
			<a href="b_list.jsp?boardid=2" class="search-nav">
			<img src="../img/core-img/qna.png" width="21px" height="21px" alt=""> 
			Q & A</a>
